...
if [ -n "${download_model}" ]; then
    ...
    # FIXME(jiatong): fix the temporary modification later
    # asr_exp="${expdir}/${download_model}"
    asr_exp=simpleoier_librispeech_asr_train_asr_conformer7_hubert_ll60k_large_raw_en_bpe5000_sp/exp/asr_train_asr_conformer7_hubert_ll60k_large_raw_en_bpe5000_sp/
    mkdir -p "${asr_exp}"
    ...
    lm_exp=simpleoier_librispeech_asr_train_asr_conformer7_hubert_ll60k_large_raw_en_bpe5000_sp/exp/lm_train_lm_transformer2_en_bpe5000/
    inference_lm=4epoch.pth
